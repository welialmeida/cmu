...
import pt.shared.ServerAndClientGeneral.response.ReadQuizResultsResponse;
...
public class ReadQuizResultsCommandHandler extends CommandHandlerImpl {

    public ReadQuizResultsCommandHandler() throws GeneralSecurityException, IOException {
        super();
    }
    ...
    public Response handle(Command cmd) {
        ...
        return new ReadQuizResultsResponse(argsMap, sessionId, getPrivKey(), getPubKey(), getRandom());
    }
}
