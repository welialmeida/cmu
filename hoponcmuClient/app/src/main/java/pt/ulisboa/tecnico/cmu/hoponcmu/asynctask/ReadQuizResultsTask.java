...
public class ReadQuizResultsTask extends AsyncTask<String, Void, String> {

    private SampleMainActivity sampleMainActivity;

    public ReadQuizResultsTask(SampleMainActivity sampleMainActivity) {
    ...
    protected String doInBackground(String[] params) {
        ...
        try {
            ...
            Log.d("DummyClient", "ReadQuizResultsTask failed..." + e.getMessage());
            e.printStackTrace();
        } finally {
            if (server != null) {
                try { server.close(); }
