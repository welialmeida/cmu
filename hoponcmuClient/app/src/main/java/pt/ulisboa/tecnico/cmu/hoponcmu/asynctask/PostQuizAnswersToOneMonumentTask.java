...
public class PostQuizAnswersToOneMonumentTask extends AsyncTask<String, Void, String> {

    private SampleMainActivity sampleMainActivity;

    public PostQuizAnswersToOneMonumentTask(SampleMainActivity sampleMainActivity) {
    ...
    protected String doInBackground(String[] params) {
        ...
        try {
            ...
            Log.d("DummyClient", "PostQuizAnswersToOneMonumentTask failed..." + e.getMessage());
            e.printStackTrace();
        } finally {
            if (server != null) {
                try { server.close(); }
